	...
	<br>
		<center>
			<table class="table table-bordered">
				<tr>
					<th class="form-actions">Tabel Data Pindahan</th>
				</tr>
				<tr>
					<th><a href="tambah_data_pindahan.php" class="btn btn-primary">Tambah Data Pindah</a>
			...
			<table class="table table-striped table-bordered dt-responsive nowrap" id="tabel">
				...
				<?php
					...
					$sql = mysqli_query($conn,"select * from data_pindah where nik LIKE '%".$search."%'");
				}else{
					$page = (isset($_GET['page']))?$_GET['page'] : 1;
					...
					$sql = mysqli_query($conn, "select * from data_pindah limit ".$limit_start.",".$limit);
				}
					$no=$limit_start + 1;
				...
				?>
						<tr>
							...
							<td>
								<?php echo '<a href="edit_data_pindah.php?nik='.$row['nik'].'" class="btn btn-priamry"><i class="fa fa-edit"></i></a>';?>
								<?php echo '<a href="database/hapus_pindah.php?id_pindah='.$row['id_pindah'].'" class="btn btn-danger"><i class="fa fa-trash"></i></a>';?>
							</td>
						</tr>
						<?php
		...
		<div class="form-actions">
			...
			?>
				<li><a href="data_pindah.php?page=1">First</a></li>
				<li><a href="data_pindah.php?page=<?php echo $link_prev; ?>"> &laquo;</a></li>
			<?php
			}
			?>
			...
			$sql2 = mysqli_query($conn, "select count(*) as jumlah from data_pindah");
			...
			?>
				<li<?php echo $link_active; ?>><a href="data_pindah.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li> 
			<?php
			}
			?>
			...
			?>
				<li><a href="data_pindah.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
				<li><a href="data_pindah.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
			<?php
			}
			?>
		</ul>
