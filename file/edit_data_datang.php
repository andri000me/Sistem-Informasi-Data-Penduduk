...
<html>
<head>
	<title>Update Data Datang</title>
...
<body style="background: #ffffff;font-family: cyan;">
	...
	<div  class="col m10 s12 offset-m1">
		...
		<?php
			...
			$sql = mysqli_query($conn, "select * from data_datang where id_datang='$id_datang'");
		...
		?>
		<form action="database/edit_data_datang.php" method="post">
			<div class="col m10 s12">

				<div class="row">
					<div class="input-field col m4 s12">
						<input type="hidden" id="id_datang" class="validate" name="id_datang" value="<?php echo $data['id_datang'];?>">
						<label for="id_datang"></label>
					</div>
				</div>
				<div class="row">
					<div class="input-field col m4 s12">
						<input type="text" id="tanggal_datang" class="validate" name="tanggal_datang" value="<?php echo $data['tanggal_datang'];?>">
				...
				<div class="row">
					...
					<div class="input-field col m8 s12">
						<input type="text" id="asal" class="validate" name="asal" value="<?php echo $data['asal'];?>">
