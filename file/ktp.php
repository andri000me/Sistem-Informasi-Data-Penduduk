	...
	<br>
		<center>
			<table class="table table-bordered">
				<tr>
					<th class="form-actions">Tabel Kartu Tanda Penduduk</th>
				</tr>
				<tr>
					<th><a href="tambah_data_ktp.php" class="btn btn-primary">Daftar Baru</a>
					<button class="btn btn-warning" onclick="PrintDoc();"><i class="fa fa-print"></i></button></th>
				</tr>
				</table>
		</center>
			...
			<div class="x_content">
				...
				<?php
					...
					$sql = mysqli_query($conn,"select * from data_ktp where nama LIKE '%".$search."%'");
				}else{
					$page = (isset($_GET['page']))?$_GET['page'] : 1;
					...
					$sql = mysqli_query($conn, "select * from data_ktp limit ".$limit_start.",".$limit);
				}
					$no=$limit_start + 1;
				...
				?>
						<tr>
							...
							<td>
								<?php echo '<a href="detail_ktp.php?id_ktp='.$row['id_ktp'].'" class="btn btn-default"><i class="fa fa-search-plus"></i></a>';?>
								<?php echo '<a href="edit_data_ktp.php?id_ktp='.$row['id_ktp'].'" class="btn btn-priamry"><i class="fa fa-edit"></i></a>';?>
								<?php echo '<a href="database/hapus.php?id_ktp='.$row['id_ktp'].'" class="btn btn-danger"><i class="fa fa-trash"></i></a>';?>
							</td>
						</tr>
						<?php
		...
		<div class="form-actions">
			...
			?>
				<li><a href="ktp.php?page=1">First</a></li>
				<li><a href="ktp.php?page=<?php echo $link_prev; ?>"> &laquo;</a></li>
			<?php
			}
			?>
			...
			$sql2 = mysqli_query($conn, "select count(*) as jumlah from data_ktp");
			...
			?>
				<li<?php echo $link_active; ?>><a href="ktp.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li> 
			<?php
			}
			?>
			...
			?>
				<li><a href="ktp.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
				<li><a href="ktp.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
			<?php
			}
			?>
		</ul>
